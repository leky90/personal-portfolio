...
export const metadata: PageMetadata = {
  ...
  description:
    "Concept demo: 12 năm nghề (2014 tới 2026) khai quật như di chỉ khảo cổ. Cuộn để đào xuyên 5 địa tầng có thật, từ freelance PHP tới dApp TypeScript, probe từng mảnh module để carbon-date.",
};
