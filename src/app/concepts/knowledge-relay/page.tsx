...
export const metadata: PageMetadata = {
  ...
  description:
    "Concept demo: mười hai năm nghề (2014–2026) vẽ thành biểu đồ relay kiểu Marey. Cuộn để chạy từ khách freelance ở Huế tới đội frontend Treehouse: mỗi lane lần lượt nguội đi nhưng những cây gậy practice vẫn được trao tiếp, vì thứ senior để lại sống lâu hơn codebase.",
};
