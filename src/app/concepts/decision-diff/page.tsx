...
export const metadata: PageMetadata = {
  ...
  description:
    "Concept demo: 12 năm quyết định kiến trúc compile thành đường ray 3D. Nhánh đã chọn đông đặc diff-green, con đường không đi treo dạng bóng ma nét đứt kèm chi phí.",
};
