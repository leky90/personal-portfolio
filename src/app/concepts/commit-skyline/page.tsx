...
export const metadata: PageMetadata = {
  ...
  description:
    "Concept demo: 4745 ngày commit (2014 → 2026) dựng thành thành phố đêm trong sương. Cuộn để bay dọc đại lộ sự nghiệp, mỗi block một năm; tháp beacon xanh đánh dấu những ngày đổi nghĩa: freelance, Synova, TESO, Treehouse.",
};
