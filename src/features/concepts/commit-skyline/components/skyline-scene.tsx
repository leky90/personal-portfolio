...
/**
 * Toàn bộ ngày (2014 → 2026) = MỘT InstancedMesh (matrix scale theo commit,
  ...
  return (
    <>
      ...
      <group>
        ...
        {/* Mọi ngày commit của 13 block năm: MỘT draw call */}
        <instancedMesh
          ref={buildingsRef}
        ...
        {/* Mặt phố ướt tối — plane 400 đơn vị phủ dư 13 block năm (~231 đơn vị x) */}
