...
const EngineCanvasLazy = lazy(() =>
  import("@/features/concepts/leverage-engine/components/engine-canvas").then((mod) => ({ default: mod.EngineCanvas })),
);
  ...
  return (
    <div aria-hidden="true" className="fixed inset-0 -z-10">
      {prefersReduced ? (
        ...
        <Suspense fallback={<ScenePoster note="Đang cắt răng bánh răng…" />}>
