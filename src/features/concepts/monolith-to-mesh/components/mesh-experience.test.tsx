...
describe("MeshExperience — layout DOM của trang concept", () => {
  ...
  it("5 chương theo năm 2016 → 2026, có nhịp gộp ngược 2021", () => {
    render(<MeshExperience />);
    for (const year of ["2016", "2018", "2021", "2023", "2026"]) {
  ...
  it("era stepper là anchor nav a11y tới từng chương", () => {
    ...
    for (const anchor of ["#ch-2016", "#ch-2018", "#ch-2021", "#ch-2023", "#ch-2026"]) {
