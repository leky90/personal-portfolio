    ...
    <div ref={containerRef} className="relative">
      ...
      <section className="mx-auto flex min-h-dvh w-full max-w-5xl flex-col justify-center px-4 pt-20 sm:px-6">
        <p className="font-mono text-[11px] tracking-[0.3em] text-[#fbbf24] uppercase">
          git log của một chiếc bàn · 2016 → 2026
        </p>
        ...
        <p className="mt-5 max-w-md text-sm leading-relaxed text-neutral-400">
          Mười năm sự nghiệp gói trong một góc bàn isometric. Cuộn để
          scrub từng commit: laptop nóng ran 2016 nhường chỗ cho màn
          đôi 2019, rồi một cú refactor lớn 2022, và tới 2026 bàn gần
          trống. Rê lên từng đồ vật để đọc lý do — trưởng thành ở đây
          đọc được bằng số thứ bị remove.
        </p>
        <p className="mt-8 font-mono text-xs text-neutral-500 motion-safe:animate-pulse">
          ↓ cuộn: commit đầu tiên năm 2016
        </p>
      </section>
